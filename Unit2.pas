...
begin
  ...
  EndTime:=now;
  CloseFile(F);
  EndMessage('3', timeToStr(EndTime-StartTime), inttostr(c));
end;

procedure TCreatorForm.x4simbClick(Sender: TObject);
Var
  s, s0, s1, s2, s3,  c : integer;
...
begin
  ...
  CloseFile(F);
  EndTime:=now;
  EndMessage('4', timeToStr(EndTime-StartTime), inttostr(c));
end;

procedure TCreatorForm.x5simbClick(Sender: TObject);
Var
  s, s0, s1, s2, s3, s4, c : integer;
...
begin
  ...
  CloseFile(F);
  EndTime:=now;
  EndMessage('5', timeToStr(EndTime-StartTime), inttostr(c));
end;

procedure TCreatorForm.x6simbClick(Sender: TObject);
Var
  s, s0, s1, s2, s3, s4, s5, c : integer;
...
begin
  ...
  CloseFile(F);
  EndTime:=now;
  EndMessage('6', timeToStr(EndTime-StartTime), inttostr(c));
end;

procedure TCreatorForm.x7simbClick(Sender: TObject);
Var
  s, s0, s1, s2, s3, s4, s5, s6, c : integer;
...
begin
  ...
  CloseFile(F);
  EndTime:=now;
  EndMessage('7', timeToStr(EndTime-StartTime), inttostr(c));
end;

procedure TCreatorForm.x8simbClick(Sender: TObject);
Var
  s, s0, s1, s2, s3, s4, s5, s6,s7, c : integer;
...
begin
  ...
  CloseFile(F);
  EndTime:=now;
  EndMessage('8', timeToStr(EndTime-StartTime), inttostr(c));
end;

procedure TCreatorForm.x9simbClick(Sender: TObject);
Var
  s, s0, s1, s2, s3, s4, s5, s6,s7, s8, c : integer;
...
begin
  ...
  CloseFile(F);
  EndTime:=now;
  EndMessage('9', timeToStr(EndTime-StartTime), inttostr(c));
end;
